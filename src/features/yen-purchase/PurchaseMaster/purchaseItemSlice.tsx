...
const EXPORT_CSV_URL = 'http://192.168.1.109:8000/purchasetestapi/rawMaterials/export_csv';
...
export const fetchPurchaseItems = createAsyncThunk(
  ...
  async ({
    ...
    try {
      ...
      const response = await purchaseApi.get('http://192.168.1.109:8000/purchasetestapi/rawMaterials/', { 
        params,
...
export const fetchUom = createAsyncThunk('uom/fetch', async () => {
  try {
    ...
    const response = await purchaseApi.get<UOM[]>('http://192.168.1.109:8000/purchasetestapi/purchaseuoms/', {
...
export const fetchPurchaseItemtype = createAsyncThunk('itemtype/fetch', async () => {
  try {
    ...
    const response = await purchaseApi.get<PurchaseItemType[]>('http://192.168.1.109:8000/purchasetestapi/itemtypes/', {
...
export const fetchPurchaseTaxes = createAsyncThunk('purchaseTaxes/fetch', async () => {
  try {
    ...
    const response = await purchaseApi.get('http://192.168.1.109:8000/purchasetestapi/purchasetaxes/', {
...
export const fetchStorageLocationItems = createAsyncThunk('storageLocations/fetch', async () => {
  try {
    ...
    const response = await purchaseApi.get<StorageLocationItem[]>('http://192.168.1.109:8000/purchasetestapi/storagelocations/', {
...
export const fetchPurchaseGroupItems = createAsyncThunk('groupItems/fetch', async () => {
  try {
    ...
    const response = await purchaseApi.get('http://192.168.1.109:8000/purchasetestapi/itemgroups/', {
...
export const fetchAllVendors = createAsyncThunk('vendors/fetch', async () => {
  const response = await purchaseApi.get<Vendor[]>('http://192.168.1.109:8000/purchasetestapi/vendors/',);
  ...
  async (purchase: Omit<PurchaseItem, 'purchaseitemId'>, { dispatch, rejectWithValue }) => {
    try {
      ...
      const response = await purchaseApi.post<PurchaseItem>(
        'http://192.168.1.109:8000/purchasetestapi/rawMaterials/',
        purchaseToAdd,
...
>('purchaseItems/searchPurchaseItems', async ({ searchQuery, skip, limit }) => {
  ...
  const response = await purchaseApi.get<PurchaseItemSearch[]>(
    `http://192.168.1.109:8000/purchasetestapi/rawMaterials/exact-name/`,
    {
      params: {
...
>('purchaseOrder/searchPurchaseItems', async ({ 
  ...
  try {
    ...
    const response = await purchaseApi.get<SearchResponse>(
      `http://192.168.1.109:8000/purchasetestapi/rawMaterials/search-with-stock`,
      { params }
    );
...
export const updatePurchaseItem = createAsyncThunk(
  ...
  async (purchase: PurchaseItem, { dispatch, rejectWithValue }) => {
    try {
      ...
      console.log('🆔 Update URL:', `http://192.168.1.109:8000/purchasetestapi/rawMaterials/${purchase.purchaseitemId}`);

      const response = await purchaseApi.patch<PurchaseItem>(
        `http://192.168.1.109:8000/purchasetestapi/rawMaterials/${purchase.purchaseitemId}`,
        purchaseToUpdate,
...
export const deactivatePurchaseItem = createAsyncThunk('purchaseItems/deactivate', async (id: string, { rejectWithValue }) => {
  try {
    ...
    const response = await purchaseApi.patch<PurchaseItem>(
      `http://192.168.1.109:8000/purchasetestapi/rawMaterials/${id}/deactivate`,
      { status: 'deactivated' },
...
export const activatePurchaseItem = createAsyncThunk('purchaseItems/activate', async (id: string, { rejectWithValue }) => {
  try {
    ...
    await purchaseApi.patch<PurchaseItem>(
      `http://192.168.1.109:8000/purchasetestapi/rawMaterials/${id}/activate`,
      { status: 'active' },
  ...
  async ({ file, mode }: ImportPayload, { rejectWithValue }) => {
    try {
      ...
      const response = await purchaseApi.post(
        'http://192.168.1.109:8000/purchasetestapi/rawMaterials/import_csv',
        formData,
  ...
  async (_, { rejectWithValue }) => {
    try {
      const response = await purchaseApi.get(
        'http://192.168.1.109:8000/purchasetestapi/rawMaterials/purchaseitemexport/export_csv',
        {
