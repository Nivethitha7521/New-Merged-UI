...
export const fetchPurchaseSubcategories = createAsyncThunk<PurchaseSubcategory[]>(
  ...
  async () => {
    try {
      const response = await axios.get('http://127.0.0.1:8000/yenerpapi/purchasesubcategories/',
  { headers: authHeader() });
...
export const addPurchaseSubcategory = createAsyncThunk<PurchaseSubcategory, PurchaseSubcategory>(
  ...
  async (purchaseSubcategory) => {
    try {
      const response = await axios.post('http://127.0.0.1:8000/yenerpapi/purchasesubcategories/', purchaseSubcategory,
  { headers: authHeader() });
      return response.data;
    } catch (error: any) {
  ...
  async ({ purchasesubcategoryId, purchasesubcategory }) => {
    try {
      const response = await axios.patch(
        `http://127.0.0.1:8000/yenerpapi/purchasesubcategories/${purchasesubcategoryId}`,
        purchasesubcategory,
  { headers: authHeader() }
      );
      return response.data;
...
export const deactivatePurchaseSubcategory = createAsyncThunk<PurchaseSubcategory, string>(
  ...
  async (purchasesubcategoryId) => {
    try {
      const response = await axios.patch(
        `http://127.0.0.1:8000/yenerpapi/purchasesubcategories/${purchasesubcategoryId}/deactivate`,
       {},
  { headers: authHeader() }
      );
      return response.data;
...
export const activatePurchaseSubcategory = createAsyncThunk<PurchaseSubcategory, string>(
  ...
  async (purchasesubcategoryId) => {
    try {
      const response = await axios.patch(
        `http://127.0.0.1:8000/yenerpapi/purchasesubcategories/${purchasesubcategoryId}/activate`,
       {},
  { headers: authHeader() }
      );
      return response.data;
...
>(
  ...
  async (file: File, { rejectWithValue }) => {
    try {
      ...
      'http://127.0.0.1:8000/yenerpapi/purchasesubcategories/import-csv',
        formData,
        {
          headers: { ...authHeader(),
  ...
  async (_, { rejectWithValue }) => {
    try {
      const response = await axios.get(
        'http://127.0.0.1:8000/yenerpapi/purchasesubcategories/exportsubcategory/export-csv',
        {
          responseType: 'blob',
           headers: authHeader()
        }
