...
export const fetchPurchaseSubcategories = createAsyncThunk<PurchaseSubcategory[]>(
  ...
  async () => {
    try {
      const response = await axios.get('http://192.168.1.102:8000/purchaseapi/purchasesubcategories/',
  { headers: authHeader() });
...
export const addPurchaseSubcategory = createAsyncThunk<PurchaseSubcategory, PurchaseSubcategory>(
  ...
  async (purchaseSubcategory) => {
    try {
      const response = await axios.post('http://192.168.1.102:8000/purchaseapi/purchasesubcategories/', purchaseSubcategory,
  { headers: authHeader() });
      return response.data;
    } catch (error: any) {
  ...
  async ({ purchasesubcategoryId, purchasesubcategory }) => {
    try {
      const response = await axios.patch(
        `http://192.168.1.102:8000/purchaseapi/purchasesubcategories/${purchasesubcategoryId}`,
        purchasesubcategory,
  { headers: authHeader() }
      );
      return response.data;
...
export const deactivatePurchaseSubcategory = createAsyncThunk<PurchaseSubcategory, string>(
  ...
  async (purchasesubcategoryId) => {
    try {
      const response = await axios.patch(
        `http://192.168.1.102:8000/purchaseapi/purchasesubcategories/${purchasesubcategoryId}/deactivate`,
       {},
  { headers: authHeader() }
      );
      return response.data;
...
export const activatePurchaseSubcategory = createAsyncThunk<PurchaseSubcategory, string>(
  ...
  async (purchasesubcategoryId) => {
    try {
      const response = await axios.patch(
        `http://192.168.1.102:8000/purchaseapi/purchasesubcategories/${purchasesubcategoryId}/activate`,
       {},
  { headers: authHeader() }
      );
      return response.data;
...
>(
  ...
  async (file: File, { rejectWithValue }) => {
    try {
      ...
      'http://192.168.1.102:8000/purchaseapi/purchasesubcategories/import-csv',
        formData,
        {
          headers: { ...authHeader(),
  ...
  async (_, { rejectWithValue }) => {
    try {
      const response = await axios.get(
        'http://192.168.1.102:8000/purchaseapi/purchasesubcategories/exportsubcategory/export-csv',
        {
          responseType: 'blob',
           headers: authHeader()
        }
