...
const OrderTypeDialog: React.FC<OrderTypeDialogProps> = ({
  open,
  handleClose,
  handleSubmit,
  handleChange,
  ...
  return (
    ...
    >
      <DialogTitle className='dialog-title'>{mode === 'edit' ? 'Edit' : 'Add'} Order Type</DialogTitle>
        ...
        <div className="form-section">
          <div className="form-field">
            <TextField
              ...
              name="orderTypeName"
              value={orderTypeData.orderTypeName || ''}
              onChange={handleTextChange}
              inputProps={{ maxLength: 30 }}
              fullWidth
              required
              inputRef={inputRef}
              error={!!validationErrors.orderTypeName || hasLetterError(orderTypeData.orderTypeName)}
              helperText={getHelperText(orderTypeData.orderTypeName, validationErrors.orderTypeName)}
      ...
      <DialogActions className='dialog-actions'>
        ...
        >
          ...
          ) : orderTypeData.id ? 'Update' : 'Create'}
        </button>
      </DialogActions>
    </Dialog>
  );
