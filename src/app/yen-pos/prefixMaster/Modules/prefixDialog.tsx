...
const InventoryDialog: React.FC<PrefixDialogProps> = ({
  open,
  handleClose,
  handleSubmit,
  handleChange,
  ...
  return (
    ...
    >
      <DialogTitle className="dialog-title">{mode === 'edit' ? 'Edit' : 'Add'} Invoice Prefix</DialogTitle>
        ...
        <div className="form-section">
          <div className="form-field">
            <TextField
              autoComplete="off"
              margin="dense"
              label="Invoice Prefix Name"
              name="invoicePrefix"
              value={prefixData.invoicePrefix || ''}
              onChange={handleTextChange}
              inputProps={{ maxLength: 30 }}
              fullWidth
              required
              inputRef={inputRef}
              error={!!validationErrors.invoicePrefix || hasLetterError(prefixData.invoicePrefix)}
              helperText={ getHelperText(prefixData.invoicePrefix, validationErrors.invoicePrefix)}
