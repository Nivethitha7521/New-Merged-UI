...
>
          ...
          <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
            ...
            <span>
              ...
              >
                {importing ? <CircularProgress size={16} /> : <UploadIcon />}
              </IconButton>
            </span>
            <Typography
              variant="caption"
          ...
          <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
            <span>
              <IconButton
                ...
                disabled={exporting}
              >
                {exporting ? <CircularProgress size={16} /> : <GetAppIcon />}
              </IconButton>
            </span>
            <Typography
              variant="caption"
      ...
      >
        ...
        <DialogContent>
          <DialogContentText id="import-confirmation-dialog-description">
            Are you sure you want to import {selectedFile?.name}? This action may overwrite existing service data.
          </DialogContentText>
        </DialogContent>
        <DialogActions>
