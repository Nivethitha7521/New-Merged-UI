...
const res = await fetch(
  `https://yenerp.com/purchaseapi/users/forgot-password?${query.toString()}`,
  { method: "POST" }
);
...
sessionStorage.setItem("fp_username", username);
 ...
 setIsAutoFetching(true);
  try {
    const res = await fetch(
     `https://yenerp.com/purchaseapi/users/email/${encodeURIComponent(mail)}/username`
...
const fetchEmailByUsername = async (uname: string) => {
 ...
 ;
  try {
    const res = await fetch(
    `https://yenerp.com/purchaseapi/users/username/${encodeURIComponent(uname)}/email`
