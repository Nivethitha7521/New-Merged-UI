...
const HARD_MODULES: AppPermissions[] = [
  ...
  actions: { read: false, add: false, edit: false, delete: false, hide: false, approve: false } 
      ...
      },
      {
       ...
       name: "Service Order",
       submodules: [
       { id: "so_pending", name: "Pending", actions: { read: false, add: false, edit: false, delete: false, hide: false, approve: false } },
       { id: "so_approved", name: "Approved", actions: { read: false, add: false, edit: false, delete: false, hide: false, approve: false } },
       { id: "so_rejected", name: "Rejected", actions: { read: false, add: false, edit: false, delete: false, hide: false, approve: false } }
  ]
},
...
so_approved: (
  <div>
    ...
    <ul className="list-disc pl-4 space-y-1">
      ...
      <li>
        <b>Edit permission controls:</b> Convert to AP and Move to Pending actions.
      </li>
    </ul>
  </div>
),
...
return;
  ...
  try {
    ...
    const roleResponse = await fetch("http://192.168.1.102:8000/purchaseapi/roles", {
      method: "POST",
 ...
 if (!roleResponse.ok) {
  ...
  return; // ❗ stop execution, no throw, no console error
    ...
    const permResponse = await fetch("http://192.168.1.102:8000/purchaseapi/permissions", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
