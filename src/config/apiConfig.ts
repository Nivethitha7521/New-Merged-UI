...
export const MASTER_ADMIN_API_BASE =
  process.env.NEXT_PUBLIC_MASTER_ADMIN_API_BASE || 'http://127.0.0.1:8000/purchasetestapi';

export const FAST_API_BASE =
  process.env.NEXT_PUBLIC_FAST_API_BASE || 'http://127.0.0.1:8000/purchasetestapi';
